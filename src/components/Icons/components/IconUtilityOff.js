...
const SvgIconUtilityOff = props => (
  <svg width={182} height={87} {...props}>
    <defs>
      <linearGradient
        id="icon-utility-off_svg__r"
        x1="47.17%"
        x2="52.88%"
        y1="45.25%"
        y2="55.13%"
      ...
      <g opacity={0.6}>
        ...
        <g fillRule="nonzero">
          ...
          <path
            ...
            d="M17.67 9.656s.095-3.68-.222-4.015c-.316-.336-.704-.555-1.235-.852 0 0-3.68-1.601-5.858-3.617a68.26 68.26 0 01-.87-.82l.403 6.07H5.81L.143 9.289c1.393 1.328 2.477 2.797 3.119 4.219 1.892 4.195 2.248 7.523 2.13 11.195 0 0 8.153.172 10.046-.875 1.892-1.047 1.828-1.867 2.248-3.734.396-1.867 1.757-8.742-.016-10.438z"
            transform="translate(163 51)"
          />
          <path
        ...
        <path
          ...
          fillRule="nonzero"
          d="M7.196 49.957C7.628 31.76 8 23.839 8 22.616c0-.931-1.89-3.448-2.8-4.616a104.32 104.32 0 00-.72 5.563C2.955 38.436 3 49.759 3 49.759c2.375.379 4.196.198 4.196.198z"
        />
        <path
        ...
        <path
          ...
          fillRule="nonzero"
          d="M3 40.739L7.885 41c.035-1.314.08-2.56.115-3.739L3.194 37A255.62 255.62 0 003 40.739z"
        />
        <path
        ...
        <g fillRule="nonzero">
          ...
          />
          <path
            fill="url(#icon-utility-off_svg__p)"
            d="M2.932.888z"
            transform="translate(0 47)"
          />
          <path
          ...
          <path
            ...
            d="M20.402 8.78l-5.177-5.953-7.827-.913S5.46 2.1 2.932 1.712c0 0-.606.057-.88.606C1.777 2.86 1.002 5 1.002 6.26c0 1.26.339 6.687.339 6.687s-1.05.404-1.05 1.664c0 1.26.54 3.901 3.432 4.62 2.884.71 10.694 1.72 10.694 1.72s0-4.805 2.278-8.262a14.888 14.888 0 013.715-3.877c0-.024-.008-.032-.008-.032z"
            transform="translate(0 47)"
          />
        </g>
        <path
        ...
        <circle
          ...
          cy={73}
          r={14}
          fill="url(#icon-utility-off_svg__y)"
          fillRule="nonzero"
        />
        <circle
          cx={152}
          cy={73}
          r={9}
          fill="url(#icon-utility-off_svg__z)"
          fillRule="nonzero"
        />
        <circle
          cx={30}
